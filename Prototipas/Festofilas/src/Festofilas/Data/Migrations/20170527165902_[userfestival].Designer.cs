...
namespace Festofilas.Data.Migrations
{
    ...
    [Migration("20170527165902_[userfestival]")]
    partial class userfestival
    {
        protected override void BuildTargetModel(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity("Festofilas.Data.Model.Article", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("Festofilas.Data.Model.ArticleFestival", b =>
                {
                    b.Property<int>("ArticleId");

                    b.Property<int>("FestivalId");

                    b.HasKey("ArticleId", "FestivalId");

                    b.HasIndex("ArticleId");

                    b.HasIndex("FestivalId");

                    b.ToTable("ArticleFestival");
                });

            modelBuilder.Entity("Festofilas.Data.Model.Comment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("Festofilas.Data.Model.ArticleFestival", b =>
                {
                    b.HasOne("Festofilas.Data.Model.Festival", "Festival")
                        .WithMany("ArticleFestivals")
                        .HasForeignKey("ArticleId")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.HasOne("Festofilas.Data.Model.Article", "Article")
                        .WithMany("ArticleFestivals")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.EntityFrameworkCore.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("Festofilas.Models.ApplicationUser")
                        .WithMany("Claims")
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade);
                });
